  ...
  return (
    <nav className="flex flex-col gap-2">
      <div className="glaze-card mb-5 flex flex-col items-center gap-3 text-center">
        <div className="bg-background text-accent border-surface flex h-28 w-28 items-center justify-center overflow-hidden rounded-full border-4 text-2xl font-black">
          {initials}
        </div>
